...
public class SearchStreetsByNameAndCityNameAndCountryName<T extends Model> extends ForwardingCommand<T> {
    private FindEntitiesByNameAndCityNameAndCountryName<T> finder;

    public SearchStreetsByNameAndCityNameAndCountryName(
            Class<T> clazz,
            HttpServlet servlet,
